...
In simple words, no.  This is no a template or the only way, but it serve the purpose of simplifying the starting process of a new project.  It's a work-in-progress project and will have changes in the future.  For now we'll track new features or pending implementations via [issues](https://github.com/HeadspringLabs/hs-react-starter/issues).
